...
│   ├── dcimgui_impl.cpp      # dear\_bindings impl glue
│   ├── imgui/                # submodule: ocornut/imgui
│   ├── dear_bindings/        # submodule: dearimgui/dear\_bindings
│   └── java/
│       └── imgui/
...
The JNI bindings and build script in this repo are GLP v3 licensed.
